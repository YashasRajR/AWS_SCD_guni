...
| 28 | Social post generator | ✅ Done | commit `eea11d7` — best guess; no spec text for this section survived into this doc. A "Copy social post" button on Speakers/Sessions/Announcements builds a templated caption client-side and copies it to the clipboard. No AI generation, no real posting. |
