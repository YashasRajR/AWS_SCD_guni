...
export default defineConfig({
  ...
  // strictPort: fail loudly if the configured port is taken instead of
  // silently binding to the next free one — a silent fallback previously
  // sent a user to an unrelated local site and looked like a bug here.
