...
import { aboutSectionsRouter, aboutSectionsAdminRouter } from '../modules/about-sections/about-sections.routes.js';
import { schedulePdfRouter, schedulePdfAdminRouter } from '../modules/schedule-pdf/schedule-pdf.routes.js';
 ...
 * AUTH, ATTENDEE (/me/*, ownership-scoped), ADMIN
...
apiRouter.use('/about-sections', aboutSectionsRouter);
apiRouter.use('/schedule-pdf', schedulePdfRouter);
...
apiRouter.use('/admin/content/about-sections', aboutSectionsAdminRouter);
apiRouter.use('/admin/schedule-pdf', schedulePdfAdminRouter);
